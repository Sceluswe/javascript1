...
(function(){
	...
	var isBaddieMovable = function(moveLeft, moveTop) {
		...
		max = document.getElementById('content').offsetWidth;
		...
		max = document.getElementById('content').offsetHeight;
...
// UNCOMMENT THIS FUNCTION TO BE ABLE TO CONTINUE
	var moveBaddie = function(moveLeft, moveTop) {
        ...
        // Debug move:
        console.log("Moving Baddie to X:" + left + ", Y:" + top);
	};
